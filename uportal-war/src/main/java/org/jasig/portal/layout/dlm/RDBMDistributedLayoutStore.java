...
public class RDBMDistributedLayoutStore extends RDBMUserLayoutStore {
...

    {
        ...
        // If this user is an owner then ownedFragment will be non null. For fragment owners and owners of any 
        // default layout from which a fragment owners layout is copied there should not be any imported
        // distributed layouts. Instead, load their PLF, mark as an owner if a fragment owner, and return.
        ...
        // If user is not an owner, create a composite ILF using the PLF and the layouts applicable to the user.
        else {
            final Locale locale = profile.getLocaleManager().getLocales()[0];

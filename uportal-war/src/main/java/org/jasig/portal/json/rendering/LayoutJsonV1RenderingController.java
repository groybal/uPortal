...
public class LayoutJsonV1RenderingController {
    ...
    public void v1RenderRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        this.internalRenderRequest(request, response);
    }

    private void internalRenderRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private void setStylesheetName(final HttpServletRequest request) {
        request.setAttribute(JsonStructureAttributeSource.STYLESHEET_NAME_REQUEST_ATTRIBUTE, STYLESHEET_NAME);
        request.setAttribute(JsonStructureTransformerSource.STYLESHEET_NAME_REQUEST_ATTRIBUTE, STYLESHEET_NAME);
    }

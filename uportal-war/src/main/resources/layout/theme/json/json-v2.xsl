...
<!-- 
 ...
 |
 | This purpose of this file ist to provide structure and theme data for use in 
...
<!-- 
 | Date: 04/01/2015
 | Company: Unicon, Inc.
 | uPortal Version: TBD (uP5.0 ?)
 |
 | General Description: This file, json-v2.xsl, was developed for sending layout data to the UI 
 | for use in rendering the uPortal UI using Javascript.  The original json.xsl file is now considered
 | 'version 1' and this new file is 'version 2'.  The original endpoint, "/uPortal/layout.json", has been 
 | preserved for backwards compatibility.  However, the same content is now also available at:
 | "/uPortal/layout/v1/layout.json".  A new endpoint, "/uPortal/layout/v2/layout.json", which utilizes
...
<xsl:param name="WINDOW_STATE_FOR_PORTLET_URLS">DETACHED</xsl:param>
